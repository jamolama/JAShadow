...
// JAShadow
#define COCOAPODS_POD_AVAILABLE_JAShadow
#define COCOAPODS_VERSION_MAJOR_JAShadow 0
#define COCOAPODS_VERSION_MINOR_JAShadow 1
#define COCOAPODS_VERSION_PATCH_JAShadow 0
